    ...
    <section class="quote-area">
      <div class="container">
        <div class="row justify-content-center text-left section-title-wrap">
          ...
          <div class="container">
            <h2> DEPARTMENTS </h2>
            [[ THE FOLLOWING ARE THE REGISTERED DEPARTMENTS ]] :::
                ...
                <!-- [ LOOP THE CLEARANCE STATUS OF THE STUDENTS ] -->
                  ...
                  <?php
                    ...
                    while($row = mysqli_fetch_array($result, MYSQLI_NUM)){
                      ...
                      echo '<td>'.$row[1].'</td>';
                      echo '
                        <td><button type="submit" class="btn btn-secondary mb-2" name="add_dept">Remove</button></td>
                      ';
                      echo '</tr>';
                    }
                  ?>
            ...
            <form method="post" action="departments.php">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="department" class="form-control" id="exampleFormControlInput1" placeholder="department_Name">
                </div>
                <div class="form-group">
                    <!-- <label for="exampleFormControlTextarea1">Example textarea</label><br> -->
                    
                    <button type="submit" class="btn btn-primary mb-2" name="add_dept">Add Department</button>
                </div>
            </form>
