...
<section class="quote-area">
  <div class="container">
    <div class="row justify-content-center text-left section-title-wrap"></div>
      <div class="col-lg-12" style="background-color:#262533; "></div>
      <div class="container">
        <h2><b>SOLVED INCIDENTS</b></h2>
        <h2> ===========================</h2>
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <?php
              ...
              $sql = "SELECT * FROM insident where incCategoty='$dept' AND instatus='SOLVED'";
              ...
              {	
                  ...
                  echo '<tr>';;
                      ...
                      echo '<td><a style="color:red;" href="unsolve.php?id=' . $row[0] . '"><b>NOT SOLVED</b></a> </td>';
                  echo '</tr>';
              }
            ?>
          </tbody>
