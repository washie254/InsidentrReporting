...
<body>
 ...
 <header class="header_area">
  ...
  <!--================ Start Service Area =================-->
  <section class="service-area section_gap_top" style="height:100%">
        ...
        <div class="row">
          ...
          <?php
              ...
              {	
                ...
                echo '<div class="single-service col-lg-4 col-md-6">';
                echo '<div class="thumb">';
                echo '<img class="f-img img-fluid mx-auto" height="200" width="360" src="images/'.$row[4].'"/>';
                echo '</div>';
                echo '<div class="service-box"> <h3>'.$row[1].'</h3>';
                echo '<P>'.$row[3].'</P>';
                echo '<a href="maps.php">'.$row[5].'</a>';
                echo '</div></div>';
              }
          ?>
        </div>
